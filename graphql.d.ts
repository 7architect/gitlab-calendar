...
export enum CiRunnerStatus {
  /** A runner that is active. */
  Active = 'ACTIVE',
  /** A runner that is not connected. */
  NotConnected = 'NOT_CONNECTED',
  /** A runner that is offline. */
  Offline = 'OFFLINE',
  /** A runner that is online. */
  Online = 'ONLINE',
...
export type CreateSnippetPayload = {
  ...
  /**
   * CAPTCHA site key which must be used to render a challenge for the user to solve to obtain a valid captchaResponse value. Included only when an operation was not completed because "NeedsCaptchaResponse" is true. Deprecated in 13.11: Use spam protection with HTTP headers instead.
  ...
  /**
   * Spam log ID which must be passed along with a valid CAPTCHA response for an operation to be completed. Included only when an operation was not completed because "NeedsCaptchaResponse" is true. Deprecated in 13.11: Use spam protection with HTTP headers instead.
   * @deprecated Use spam protection with HTTP headers instead. Deprecated in 13.11.
   */
...
export type CustomerRelationsContact = {
  ...
  createdAt: Scalars['Time'];
  /** Description or notes for the contact. */
  description?: Maybe<Scalars['String']>;
...
export type CustomerRelationsOrganization = {
  ...
  /** Description or notes for the organization. */
  description?: Maybe<Scalars['String']>;
...
export type Issuable = Issue | MergeRequest;
...
export enum MilestoneWildcardId {
  ...
  Started = 'STARTED',
  /** Milestone assigned is due closest in the future (due date > today). */
  Upcoming = 'UPCOMING'
}
